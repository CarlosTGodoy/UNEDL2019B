...
namespace Bienes_Raices
{
    public partial class Rentar : Form
    {
        ...
        private void Rentar_Load(object sender, EventArgs e)
        {
            ...
            registros = metodos.LeerArchivo(1);
            ...
            //Traemos nuestra lista
            //1 - Renta Casas, 2 - Renta Departamento, 3 - Venta Casas, 4 - Venta Departamento
            registros2 = metodos.LeerArchivo(2);
        ...
        private void pbxCasa_Click(object sender, EventArgs e)
        {
            this.Close();
            InitializeComponent();
            DeptoDisponibleRenta ddr = new DeptoDisponibleRenta();
            ddr.MostrarInfoDepto(Casa, image, idCasa);
        }
        ...
        private void pbxDepto_Click(object sender, EventArgs e)
        {
            this.Close();
            InitializeComponent();
            CasaDisponibleRenta cdr = new CasaDisponibleRenta();
            cdr.MostrarInfoCasa(Depto, image2, idDepto);
        }
